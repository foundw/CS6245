...
; <label>:133:                                    ; preds = %129
  %134 = load double*, double** %42, align 8
  ...
  %144 = load [4000 x double]*, [4000 x double]** %46, align 8
  %145 = load i32, i32* %34, align 4
  %146 = sext i32 %145 to i64
  %147 = getelementptr inbounds [4000 x double], [4000 x double]* %144, i64 %146
  %148 = load i32, i32* %39, align 4
  %149 = sext i32 %148 to i64
  %150 = getelementptr inbounds [4000 x double], [4000 x double]* %147, i64 0, i64 %149
  %151 = load double, double* %150, align 8
  %152 = fmul double %143, %151
  %153 = fadd double %138, %152
  %154 = load double*, double** %42, align 8
  %155 = load i32, i32* %39, align 4
  %156 = sext i32 %155 to i64
  %157 = getelementptr inbounds double, double* %154, i64 %156
  store double %153, double* %157, align 8
  %158 = load double*, double** %44, align 8
  %159 = load i32, i32* %34, align 4
  %160 = sext i32 %159 to i64
  %161 = getelementptr inbounds double, double* %158, i64 %160
  %162 = load double, double* %161, align 8
  %163 = load [4000 x double]*, [4000 x double]** %46, align 8
  %164 = load i32, i32* %34, align 4
  %165 = sext i32 %164 to i64
  %166 = getelementptr inbounds [4000 x double], [4000 x double]* %163, i64 %165
  %167 = load i32, i32* %39, align 4
  %168 = sext i32 %167 to i64
  %169 = getelementptr inbounds [4000 x double], [4000 x double]* %166, i64 0, i64 %168
  %170 = load double, double* %169, align 8
  %171 = load double*, double** %47, align 8
  ...
  %178 = load double*, double** %44, align 8
...
; <label>:191:                                    ; preds = %190
  ...
  call void @__kmpc_for_static_fini(%ident_t* @0, i32 %193)
  br label %194

; <label>:194:                                    ; preds = %191, %91
  %195 = load i32*, i32** %11, align 8
  %196 = load i32, i32* %195, align 4
  call void @__kmpc_barrier(%ident_t* @1, i32 %196)
  ret void
}
