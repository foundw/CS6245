...
define internal void @kernel_trmm(i32, double, [1024 x double]*, [1024 x double]*) #0 {
  ...
  store [1024 x double]* %2, [1024 x double]** %7, align 8
  store [1024 x double]* %3, [1024 x double]** %8, align 8
  call void (%ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%ident_t* @1, i32 5, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, i32*, [1024 x double]**, double*, [1024 x double]**)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* %9, i32* %5, [1024 x double]** %8, double* %6, [1024 x double]** %7)
  ret void
}
...
; <label>:71:                                     ; preds = %67
  ...
  call void @__kmpc_critical(%ident_t* @1, i32 %73, [8 x i32]* @.gomp_critical_user_.var)
  %74 = load double, double* %29, align 8
  %75 = load [1024 x double]*, [1024 x double]** %30, align 8
  %76 = load i32, i32* %19, align 4
  %77 = sext i32 %76 to i64
  %78 = getelementptr inbounds [1024 x double], [1024 x double]* %75, i64 %77
  %79 = load i32, i32* %25, align 4
  %80 = sext i32 %79 to i64
  %81 = getelementptr inbounds [1024 x double], [1024 x double]* %78, i64 0, i64 %80
  %82 = load double, double* %81, align 8
  %83 = fmul double %74, %82
  %84 = load [1024 x double]*, [1024 x double]** %28, align 8
  ...
  %93 = load [1024 x double]*, [1024 x double]** %28, align 8
  ...
  call void @__kmpc_end_critical(%ident_t* @1, i32 %73, [8 x i32]* @.gomp_critical_user_.var)
  br label %102
...
; <label>:115:                                    ; preds = %114
  ...
  call void @__kmpc_for_static_fini(%ident_t* @0, i32 %117)
  br label %118

; <label>:118:                                    ; preds = %115, %7
  %119 = load i32*, i32** %8, align 8
  %120 = load i32, i32* %119, align 4
  call void @__kmpc_barrier(%ident_t* @2, i32 %120)
  ret void
}
