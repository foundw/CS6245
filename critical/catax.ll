...
; <label>:163:                                    ; preds = %159
  ...
  call void @__kmpc_critical(%ident_t* @2, i32 %165, [8 x i32]* @.gomp_critical_user_.var)
  %166 = load double*, double** %40, align 8
  %167 = load i32, i32* %37, align 4
  %168 = sext i32 %167 to i64
  %169 = getelementptr inbounds double, double* %166, i64 %168
  %170 = load double, double* %169, align 8
  %171 = load [4000 x double]*, [4000 x double]** %43, align 8
  %172 = load i32, i32* %32, align 4
  %173 = sext i32 %172 to i64
  %174 = getelementptr inbounds [4000 x double], [4000 x double]* %171, i64 %173
  %175 = load i32, i32* %37, align 4
  %176 = sext i32 %175 to i64
  %177 = getelementptr inbounds [4000 x double], [4000 x double]* %174, i64 0, i64 %176
...
; <label>:199:                                    ; preds = %198
  ...
  call void @__kmpc_for_static_fini(%ident_t* @0, i32 %201)
  br label %202

; <label>:202:                                    ; preds = %199, %88
  %203 = load i32*, i32** %10, align 8
  %204 = load i32, i32* %203, align 4
  call void @__kmpc_barrier(%ident_t* @1, i32 %204)
  ret void
}
